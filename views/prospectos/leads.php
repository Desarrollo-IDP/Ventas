...
$page_title = 'BD / Leads';
$page_actions = '<button class="btn btn-outline-success me-2" data-bs-toggle="modal" data-bs-target="#modalImportar"><i class="fas fa-file-excel me-1"></i> Importar Excel</button><button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalLead"><i class="fas fa-database me-1"></i> Agregar BD / Lead</button>';
...
<div class="modal fade" id="modalImportar" tabindex="-1" aria-hidden="true"><div class="modal-dialog modal-lg"><div class="modal-content"><form id="formImportar" enctype="multipart/form-data" onsubmit="importarLeads(event)"><div class="modal-header"><h5 class="modal-title"><i class="fas fa-file-excel text-success me-2"></i>Importar empresas desde Excel</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div><div class="modal-body"><p class="text-muted">Usa una fila de encabezados con: <strong>Empresa, Número, Correo electrónico, Ubicación, Informes de llamada, Estatus</strong>. También puedes subir un CSV.</p><input type="file" name="archivo" class="form-control" accept=".xlsx,.csv" required><small class="text-muted d-block mt-2">Las filas repetidas por correo, número o empresa se omitirán automáticamente.</small><div id="resultadoImportacion" class="mt-3"></div></div><div class="modal-footer"><button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Cancelar</button><button class="btn btn-success"><i class="fas fa-upload me-1"></i> Importar archivo</button></div></form></div></div></div>
